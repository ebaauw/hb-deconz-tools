...
class FirmwareClientHandler extends HttpClient {
  constructor (options = {}) {
    super(options)
...
/** Client for zigbee-OTA firmware server,
  ...
  * @extends HttpClient
  */
class ZigbeeOtaFirmwareClient extends FirmwareClientHandler {
...
/** Client for Hue firmware server.
  ...
  * @extends HttpClient
  */
class HueFirmwareClient extends FirmwareClientHandler {
...
/** Client for Ikea firmware server.
  ...
  * @extends HttpClient
  */
class IkeaFirmwareClient extends FirmwareClientHandler {
