...
class DeconzTool extends CommandLineTool {
  ...
  async _main () {
    ...
    this.clargs.options.fingerprint = this.gatewayConfig.fingerprint
  ...
  async eventlog (...args) {
    ...
    const port = websocketport_wss != null ? websocketport_wss : websocketport
    options.wss = websocketport_wss != null
